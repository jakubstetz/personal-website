const projects = [
  ...
  },
  {
    ...
    description:
      "Single-page portfolio site for showcasing projects, background, and contact information. Built with React, styled with vanilla CSS, and animated with Motion.",
